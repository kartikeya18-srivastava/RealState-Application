        ...
        <div className="container">
          ...
          <div className="mx-5 collapse navbar-collapse" id="navbarNav">
            ...
            <div className="d-flex align-items-center gap-3">
              <button className="btn btn-danger btn1 px-4 py-2" onClick={handleLogout}>LogOut</button>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="container">
          ...
          <div className="mx-5 collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-sm-0">
              ...
              <li className="nav-item"><Link className="nav-link text-dark fw-bold" to="/user-bought-list">Bought</Link></li>
      ...
      <nav className="navbar navbar-expand-sm bg-white border-bottom shadow-sm sticky-top">
        <div className="container">
          ...
          <div className="mx-5 collapse navbar-collapse" id="navbarNav">
            ...
            <div className="d-flex align-items-center gap-3">
              <Link to='/register'><button className="btn btn-danger btn1 px-4 py-2">Registration</button></Link>
              <Link to='/login'><button className="btn btn-danger btn1 px-4 py-2">Login</button></Link>
            </div>
          </div>
        </div>
      </nav>
